            ...
            <div className="w-full max-w-md">
                ...
                <Card className="border-none shadow-2xl shadow-emerald-100/50 backdrop-blur-sm bg-white/80">
                    <CardHeader className="space-y-1 text-center">
                        <CardTitle className="text-2xl font-bold tracking-tight text-gray-900">Sign In</CardTitle>
                    ...
                    <CardContent className="space-y-4">
                        <Button
                            ...
                            className="w-full py-6 bg-white hover:bg-gray-50 border-gray-200 transition-all duration-200 font-medium text-lg"
                        >
